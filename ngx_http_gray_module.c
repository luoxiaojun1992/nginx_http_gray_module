...
{
  //HTTP请求头
  static ngx_str_t backendQueryLine = ngx_string("GET /v3/index/index HTTP/1.1\r\nHost: api.daishangqian.com\r\nConnection: close\r\n\r\n");
...
ngx_http_gray_handler(ngx_http_request_t * r)
{
  ...
  struct hostent *pHost = gethostbyname((char*) "api.daishangqian.com");
  if (pHost == NULL) {
